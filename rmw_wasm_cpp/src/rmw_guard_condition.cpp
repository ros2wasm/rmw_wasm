...
extern "C"
{
    ...
    {
        RCUTILS_LOG_DEBUG_NAMED("wasm_wasm", "trace rmw_create_guard_condition()");
    ...
    {
        RCUTILS_LOG_DEBUG_NAMED("wasm_wasm", "trace rmw_destroy_guard_condition()");
    ...
    {
        RCUTILS_LOG_DEBUG_NAMED("wasm_wasm", "trace rmw_trigger_guard_condition()");
