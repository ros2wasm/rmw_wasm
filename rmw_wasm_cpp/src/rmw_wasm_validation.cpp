...
namespace rmw_wasm_cpp
{
    ...
    {
        RCUTILS_LOG_DEBUG_NAMED("rmw_wasm_cpp", "trace is_valid_qos()");
    ...
    {
        RCUTILS_LOG_DEBUG_NAMED("rmw_wasm_cpp", "trace is_valid_topic_name()");
    ...
    {
        RCUTILS_LOG_DEBUG_NAMED("rmw_wasm_cpp", "trace is_valid_type_support_message()");
    ...
    {
        RCUTILS_LOG_DEBUG_NAMED("rmw_wasm_cpp", "trace is_valid_type_support_service()");
